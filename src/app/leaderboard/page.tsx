...
import { Trophy, TrendingUp, DollarSign, Target, Users, Medal, Crown, Award } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <Card className="bg-gray-800/50 border-gray-700">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold text-white">{data.meta.totalUsers}</div>
            ...
            <Card className="bg-gray-800/50 border-gray-700">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold text-white">{data.meta.activeBettors}</div>
            ...
            <Card className="bg-gray-800/50 border-gray-700">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold text-white">${data.meta.totalVolume.toFixed(0)}</div>
        ...
        {data && data.leaderboard.length > 0 ? (
          <div className="space-y-4">
            {data.leaderboard.map((user, index) => (
              <Card key={user.id} className={`transition-all duration-200 hover:border-purple-500 ${
                user.rank <= 3 ? 'bg-gradient-to-r from-gray-800/50 to-gray-800/30 border-yellow-500/30' : 'bg-gray-800/30'
              }`}>
                    ...
                    <div className="hidden md:grid grid-cols-4 gap-6 text-center">
                      <div>
                        <div className={`text-lg font-bold ${
                          ...
                          {user.stats.netProfit >= 0 ? '+' : ''}${user.stats.netProfit.toFixed(2)}
                        </div>
                      ...
                      <div>
                        <div className={`text-lg font-bold ${
                          user.stats.roi >= 0 ? 'text-green-400' : 'text-red-400'
                        }`}>
